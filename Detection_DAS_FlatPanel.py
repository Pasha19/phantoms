...
def Detection_DAS_FlatPanel(viewIn, viewId, cfg):
    ...
    if cfg.physics.DetectorAliasMode == 0:
        ...
        viewOut = viewOut.reshape((viewOut_size_2, viewOut_size))
        ...
        viewOut_alias = viewOut_filt[0:viewOut_size_2:cfg.physics.FlatPanel_OSfactor, 0:viewOut_size:cfg.physics.FlatPanel_OSfactor]
